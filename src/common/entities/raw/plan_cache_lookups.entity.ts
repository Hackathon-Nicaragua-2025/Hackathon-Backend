// raw/plan_cache_lookups.entity.ts
import { Entity, Column, CreateDateColumn, PrimaryGeneratedColumn } from 'typeorm';
import { BaseEntity } from '../base-entity.entity';
import { getSchemaName } from '../../utils/schema-prefix.util';

@Entity('plan_cache_lookups', { schema: getSchemaName('raw') })
export class PlanCacheLookups extends BaseEntity {
  @PrimaryGeneratedColumn({ type: 'int', name: 'plan_cache_lookups_id' })
  id!: number;
  ...
  @Column({ type: 'nvarchar', length: 137, name: 'physical_operator', nullable: true })
